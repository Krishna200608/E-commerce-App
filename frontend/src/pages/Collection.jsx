  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-68'>
        <p onClick={()=>setShowFitler(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>FILTER
        ...
        <div className={`border border-gray-700 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
