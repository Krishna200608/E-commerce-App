    ...
    <div className='border-t-2 border-gray-300 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
              ...
              <div className='flex flex-col gap-4 my-8'>
                ...
                <div className='flex gap-2'>
                  {productData.sizes.map((item, index)=>(
                    <button onClick={()=>setSize(item)} className={`py-2 px-4 bg-gray-100 cursor-pointer border ${item === size ? 'border-orange-500' : 'border-transparent' }`} key={index}>{item}</button>
                  ))}
                </div>
              </div>
        ...
        <div className='mt-20'>
          ...
          <RelatedProducts category={productData.category} subCategory={productData.subCategory} selectedId={productData._id}/>
